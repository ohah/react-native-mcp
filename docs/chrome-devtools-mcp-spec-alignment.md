...
| 도구          | 지원 | 비고                                                                                         |
| ------------- | ---- | -------------------------------------------------------------------------------------------- |
| `click`       | ✅   | testID(uid) 기반 단일 클릭. `evaluate_script`로 triggerPress 호출. RN에서는 더블클릭 미지원. |
| `long_press`  | ✅   | testID 또는 라벨 기반 롱프레스.                                                              |
| key (키 입력) | ✅   | `idb_key`(iOS), `adb_key`(Android)로 네이티브 키 입력.                                       |
| `fill`        | 🔲   | 예정.                                                                                        |
