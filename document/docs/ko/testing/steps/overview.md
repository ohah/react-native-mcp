---
description: 34가지 E2E YAML 스텝 타입(탭, 검증, 대기, 내비게이션, 비디오 등) 레퍼런스. 문법 및 셀렉터 규칙.
---

# 스텝 레퍼런스

E2E YAML 러너는 8개 카테고리에 걸쳐 **34가지 스텝 타입**을 지원한다. 각 스텝은 하나의 동작(탭, 검증, 대기, 내비게이션, 비디오 녹화 등)을 수행한다.
...
| [비디오](./video)                     | 2       | 화면 녹화 시작·중지 (idb/adb)                  |
