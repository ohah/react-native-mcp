...
React Native MCP에 기여해 주셔서 감사합니다. 이 페이지는 저장소 설정, 테스트 실행, 아키텍처 이해가 필요한 **개발자**를 위한 것입니다. 사용자용 문서(설치, 도구, 테스트)는 [mcp](/mcp/)와 [test](/testing/)에 있습니다.
...
- **2계층 — MCP 서버:** Node.js 프로세스, 50개 도구, 포트 12300 WebSocket, 네이티브 CLI(adb/idb).
