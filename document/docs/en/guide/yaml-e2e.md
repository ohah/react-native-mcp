...
A format supported by `@ohah/react-native-mcp-test`: one file with **platform**, **config**, and **setup / steps / teardown**.  
...
Or use the `run` script of `@ohah/react-native-mcp-test` with your YAML file.  
See the package README or [Running E2E in GitHub Actions](./e2e-github-actions) for options.

## Using in GitHub Actions

YAML scenarios work in CI as-is.  
[Running E2E in GitHub Actions](./e2e-github-actions) has workflow examples and notes.
