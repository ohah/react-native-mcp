...
Thank you for contributing to React Native MCP. This page is for **developers** who want to set up the repo, run tests, or understand the architecture. User-facing docs (install, tools, test) are in [mcp](/mcp/) and [test](/test/).
...
- **Layer 2 — MCP Server:** Node.js process exposing 48 tools, WebSocket on port 12300, and native CLI (adb/idb).
